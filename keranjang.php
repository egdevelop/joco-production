...
<body>
    ...
    <div class="body-wrapper">
                ...
                <div class="d-flex align-items-center justify-content-between py-3">
                    <div class="left d-flex align-items-center gap-3">
                        ...
                        <a onclick="history.back()" class="text-light d-flex gap-2 align-items-center">
                            <span class="fz-12 fw-bold">Keranjang Belanja</span>
                        </a>
                    </div>
                    <div class="right">
        ...
        <!-- Desktop -->
        <div class="container-lg bg-white py-3 mt-keranjang d-none d-lg-block">
            <div class="container">
                <div class="row">
        ...
        <div class="container-lg bg-white mt-4 py-3 d-none d-lg-block">
            <div class="container">
        ...
        <!-- Mobile -->
        <div class="bg-white pb-5 mb-5 d-block d-lg-none">
            <div class="mb-4">
                <div class="border-top-custom"></div>
                <div class="container pt-4 pb-3 d-flex gap-2">
                    ...
                    <div class="desc">
                        <span class="d-block fz-12 fw-600">Topi Fashion
                            Anak Laki - Laki & Perempuan</span>
                        <span class="orange fz-10 fw-600 me-3">Rp20.000</span>
                        <span class="orange fz-10 fw-600">Eceran</span>
                        <div class="wrapper">
                            <span class="minus">-</span>
                            <span class="num">1</span>
                            <span class="plus">+</span>
            ...
            <div class="container d-flex flex-column gap-2">
                <div class="d-flex align-items-center justify-content-between justify-content-sm-end">
                    ...
                    <a type="button" data-bs-toggle="modal" data-bs-target="#btnVoucher"
                        class="right d-none d-lg-flex align-items-center ps-3">
                        <span class="abu fz-11">Gunakan / masukkan kode</span>
                        <i class="abu ri-arrow-right-s-line"></i>
                    </a>
                    <!-- Mobile -->
                    <a href="voucher.php" class="right d-flex d-lg-none align-items-center ps-3">
                        <span class="abu fz-11">Gunakan / masukkan kode</span>
                        <i class="abu ri-arrow-right-s-line"></i>
                    </a>
                </div>
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="right d-flex align-items-center gap-2">
                        <div class="left">
                            <span class="fz-10 fw-500">Total (0 produk)</span>
                            <span class="d-block fz-10 fw-600 orange">Rp0</span>
                        </div>

                        <!-- Desktop -->
                        <div class="right d-none d-sm-flex">
                            <a href="checkout.php"
                                class="right text-center bg-blue fz-10 text-light px-3 py-2 w-100 h-100">
                                Checkout
                            </a>
                        </div>
