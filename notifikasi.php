...
<body>
    ...
    <div class="body-wrapper">
        ...
        <div class="bg-white pt-4 pb-3 mb-1 d-block d-lg-none">
            <div class="container">
                <a onclick="history.back()" class="text-dark d-flex gap-2 align-items-center justify-content-start">
                    ...
                    <span class="fz-16 fw-600">Notifikasi</span>
                </a>
            </div>
        </div>
        ...
        <section class="py-2 py-sm-4 px-0 px-sm-4 mt-lg-5 pt-lg-4 mb-5">
            <div class="container mt-lg-5 pt-lg-5 mb-5">
                <div class="row d-flex justify-content-center gap-2">
                    ...
                    <div class="col-12 bg-white px-0 col-lg-9 right d-flex flex-column">
                        <div class="borad-10-res p-3 p-lg-4">
                            ...
                            <hr class="my-3 py-0">
                            <div
                                class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between">
                                <div class="left d-flex align-items-center gap-2">
                                    <img src="assets/img/products1.jpg" alt="" class="productsImg">
                                    <div class="d-flex flex-column">
                                        <span class="fz-12 fw-bold">Paket Di terima</span>
                                        <span class="my-lg-1 w-70res">Jocoproduction - Topi Baseball
                                            Anak
                                            Laki-laki & Perempuan
                                            Motif bordir Alfabeth
                                        </span>
                                        <span class="fz-10res fw-500">Produk dipesan 23/04/2022</span>
                                    </div>
                                </div>
                                <div class="right mt-4 mt-lg-0">
                                    <button type="button" class="btnMember px-3 py-2 fz-10res fw-600 orange">Tampilkan
        ...
        <!-- Navbar Bottom -->
        <?php include 'components/navBottomNotif.php'; ?>
    </div>
