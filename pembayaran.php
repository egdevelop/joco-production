...
<body style="background: #fff">
    ...
    <div class="body-wrapper">
        ...
        <!-- keranjang -->
        <div class="container bg-white pt-1 pb-5 mb-5">
            <div class="container px-0">
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <div class="accordion-item">
                        <p class="accordion-header" id="flush-headingOne">
                            <button class="accordion-button d-flex align-items-center gap-2 collapsed" type="button"
                            ...
                            <div class="accordion-body mt-1 position-relative">
                                <label class="radioWrapper ps-2 row d-flex align-items-start py-3">
                                    ...
                                    <div class="col-10 ps-1 pe-1 d-flex gap-2 flex-column">
                                        ...
                                        <span class="fz-9" style="width: 90%">Hanya menerima dari Bank BCA. Metode
                                            Pembayaran Lebih Mudah</span>
                                        <input type="radio" name="radio">
                                        <span class="checkmarkMobile position-absolute top-50 me-2"></span>
                                    </div>
                                </label>
                                <label class="radioWrapper ps-2 row d-flex align-items-start py-3">
                                    <div class="col-1 left me-3">
                                    ...
                                    <div class="col-10 ps-1 pe-1 d-flex gap-2 flex-column">
                                        ...
                                        <span class="fz-9" style="width: 90%">Hanya menerima dari Bank Mandiri termasuk
                                            Bank Syariah Metode Pembayaran Lebih Mudah</span>
                                        <input type="radio" name="radio">
                                        <span class="checkmarkMobile position-absolute top-50 me-2"></span>
                                    </div>
                                </label>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body mt-1">
                                <label class="radioWrapper ps-2 row d-flex align-items-start py-3"
                                    style="border-top: 1px solid rgba(196, 196, 196, 0.2) !important;">
                                    <div class="col-1 left me-3">
                                        <img src="assets/img/alfamart.svg" alt="">
                                    </div>
                                    <div class="col-10 ps-1 pe-1 d-flex gap-2 flex-column">
                                        <span class="fw-600 fz-12">Alfamart </span>
                                        <span class="fz-10">Hanya menerima dari Alfamart. Metode Pembayaran Lebih
                                            Mudah</span>
                                        <input type="radio" name="radio">
                                        <span class="checkmarkMobile position-absolute top-50 me-2"></span>
                                    </div>
                            ...
                            <div class="accordion-body mt-1">
                                <label class="radioWrapper ps-2 row d-flex align-items-start py-3"
                                    ...
                                    <div class="col-10 ps-1 pe-1 d-flex gap-2 flex-column">
                                        ...
                                        <span class="fz-10">Hanya menerima dari Indomaret. Metode Pembayaran Lebih
                                            Mudah</span>
                                        <input type="radio" name="radio">
                                        <span class="checkmarkMobile position-absolute top-50 me-2"></span>
                                    </div>
    ...
    <!-- Navbar Bottom -->
    <div class="container-lg bg-white navbarBottomCart start-0 end-0 bottom-0 py-3 d-block d-lg-none">
        <div class="container d-flex align-items-center justify-content-end gap-3">
            <div class="left">
                <span class="fz-10 fw-500">Biaya Penanganan</span>
                <span class="d-block fz-10 fw-600 orange text-end">Rp2.500</span>
            </div>

            <div class="right d-flex d-lg-none h-100">
                <a href="checkout.php" class="right text-center h-100 bg-blue fz-10 text-light px-3 py-2 w-100 h-100">
                    Konfirmasi
                </a>
            </div>
        </div>
