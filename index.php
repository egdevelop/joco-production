...
<body>
    ...
    <div class="body-wrapper">
        ...
        <!-- Carousel -->
        <section class="d-sm-flex align-items-sm-center justify-content-sm-center px-0 container-sm position-relative mt-homepage">
            ...
            <div class="bg-white-bannerSale -bannerSale mt-3 mt-sm-0">
                <div class="d-flex align-items-center flex-sm-column justify-content-between justify-content-sm-start gap-2">
        ...
        <!-- Flash Sale -->
        <div class="swiper-container container slider1 bg-white py-4 px-3 px-sm-4 mt-4">
            <div class="d-flex justify-content-between justify-content-sm-start gap-sm-4 mt-1 mb-2">
                    ...
                    <a href="detail-produk.php" class="mt-2">
                        ...
                        <div class="card-body pt-2 d-flex flex-column align-items-center justify-content-center">
                            <div class="d-flex justify-content-between gap-1">
                                <div class="abu fz-10 fw-bold text-decoration-line-through">Rp. 55.000
                                </div>
                                <div class="text-light fz-9 fw-bold bg-yellow px-flash">57% OFF</div>
                            </div>
                            <p class="orange fw-bold mt-1">Rp23.400</p>
                            <div class="progress bg-blue-muda w-100 borad-10">
                                <div class="progress-bar bg-blue text-light fz-11 text-center w-50 border-l-radius-10 px-1" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">12 terjual
                                </div>
                            </div>
                        </div>
                    </a>
            ...
            <div class="d-none d-md-flex align-items-center justify-content-center listing-carousel-button listing-carousel-button-next">
                <i class="ri-arrow-right-s-line" style="color: #000;font-size: 2rem;"></i>
            </div>
            <div class="d-none d-md-flex align-items-center justify-content-center listing-carousel-button listing-carousel-button-prev">
                <i class="ri-arrow-left-s-line" style="color: #000;font-size: 2rem;"></i>
            </div>
        </div>

        <!-- Hot Products -->
        <div class="swiper-container container slider2 bg-white py-4 px-3 px-sm-4 mt-4">
            <div class="d-flex justify-content-between mt-1 mb-2">
                <div class="left d-flex align-items-center">
                    <span class="fz-20 fw-bold">Hot Products</span>
        ...
        <div class="container bg-white-products pt-2 pb-4 px-3 px-sm-0 mt-1 mb-5">
            <div class="row">
                <?php
                        $products = getAllProducts();
                        foreach ($products as $product) {
                            $pics = explode('|', $product['photos']);
                        ?>
                <div class="col-6 col-sm-4 col-md-3 col-xl-2 px-2 my-2">
                    <a href="detail-produk.php?id=<?= $product['id'] ?>">
                        <div class="card">
                            <img src="<?= $pics[0] ?>" alt="" class="w-100">
                            <div class="d-flex flex-column desc py-2 px-2 px-lg-3">
                                <span class="text-dark fw-600 mt-1 mb-2 fz-12 fw-600"><?= $product['name'] ?>
                                </span>
                                <span class="orange fw-bold fz-10"><?= rupiahFormat($product['retail_price']) ?></span>
                                <div class="d-flex justify-content-between flex-column flex-sm-row">
                                    ...
                                    <div class="right">
                                        <span class="black fz-10 fw-600"><?= $product['sold'] ?> terjual</span>
                                    </div>
                                </div>
                            </div>
                        </div>
